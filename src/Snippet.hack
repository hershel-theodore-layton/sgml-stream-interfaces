...
interface Snippet {
   ...
   * method is called before primeAsync is called. This method may not be called
   * more than once. Implementations are not required to behave correctly when
   * this method is called more than once. If an implementation needs to
